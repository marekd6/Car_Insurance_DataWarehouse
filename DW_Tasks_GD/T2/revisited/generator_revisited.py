...
client_ids = list(range(1, 1000001))
car_ids = list(range(1, 1000001))
...
for i in range(NUMBER_OF_CLAIMS):
    ...
    # submission date
    sub = SUBMISSION_START + datetime.timedelta(weeks=52*random.randint(0, SUBMISSION_DELTA), days=random.randint(1,30))
