...
# somehow changed: class, size, spec, sex
...
car_class = ['cheap', 'medium', 'premium', 'cheap', 'medium', 'cheap', 'medium', 'premium']
car_size = ['small', 'medium', 'large', 'small', 'medium', 'medium', 'large', 'cargo']
...
for i in range(NUMBER_OF_CLIENTS):
    ...
    accs.append(f.iban())
    # insert
    if i % SEX_MODULO < MALE_THRESHOLD:
        # a male
...
def generate_specialisation():
    return random.choice(["cargo", "casual", "cargo", "casual", "cargo", "casual", "premium", "premium", "premium"])
