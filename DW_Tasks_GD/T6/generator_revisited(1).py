...
BIRTHDAY_START = datetime.date(1943, 1, 1)
...
car_types.to_csv('CSVs/car_types.csv', index_label='ID')
...
file = open('CSVs/cars.csv', 'w', encoding='utf-8-sig', newline='')
...
# save the data frame to the csv file
parts.to_csv('CSVs/parts.csv', index=False)
print('parts ready!')
...
for i in range(NUMBER_OF_CLIENTS):
    ...
    # date of birth
    birth = BIRTHDAY_START + datetime.timedelta(weeks=random.randint(1, BIRTH_DELTA * 52), days=random.randint(1, 30))
...
# opening the csv file in 'w' mode
file = open('CSVs/clients.csv', 'w', encoding='utf-8-sig', newline='')
...
# save the data frame to the csv file
agents.to_csv('CSVs/agents.csv', index=False)
print('agents ready!')
...
# save the data frame to the csv file
assessors.to_csv('CSVs/assessors.csv', index=False)
...
# opening the csv file in 'w' mode
file = open('CSVs/ownership.csv', 'w', encoding='utf-8-sig', newline='')
...
# opening the csv file in 'w' mode
file = open('CSVs/insurances.csv', 'w', encoding='utf-8-sig', newline='')
...
for i in range(NUMBER_OF_CLAIMS):
    ...
    # submission date
    sub = SUBMISSION_START + datetime.timedelta(weeks=random.randint(0, SUBMISSION_DELTA * 52),
...
print('List ready')
# opening the csv file in 'w' mode
file = open('CSVs/claims.csv', 'w', encoding='utf-8-sig', newline='')
